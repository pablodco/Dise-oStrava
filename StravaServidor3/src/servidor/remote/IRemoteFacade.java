...
public interface IRemoteFacade extends Remote {
	...
	public long registro(String email, String password, String nombre, String fecha_nac, int peso_kilo, int altura,
			int frecuencia_card, int frecuencia_card_max,String metodo) throws RemoteException;

	public void logout(long token) throws RemoteException;

	public boolean crearEntrenamiento(long token, long duracion, String titulo, String actividad, double distincia,
			Date fecha_ini) throws RemoteException;

	public boolean crearReto(long token, int objetivo, String descripcion, String nombre, Date fecha_ini,
	...
	public double obtenerPorcentajeDeReto(RetoDTO reto, long token) throws RemoteException;
}